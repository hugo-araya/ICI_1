...
def calcula():
    ...
    if (not((lado1 + lado2 > lado3) and (lado1 + lado3 > lado2) and (lado2 + lado3 > lado1))):
        ...
        result.delete("1.0", tk.END)
        result.insert(tk.INSERT, "ISÓCELES")
...
def dibuja():
    ...
    result.pack()    
    return ventana, lblPrimerLado, txtPrimerLado, lblSegundoLado, txtSegundoLado, txtSegundoLado, lblTercerLado, txtTercelLado, btnClasificar, result

if __name__ == '__main__':
    ventana, lblPrimerLado, txtPrimerLado, lblSegundoLado, txtSegundoLado, txtSegundoLado, lblTercerLado, txtTercelLado, btnClasificar, result = dibuja()
